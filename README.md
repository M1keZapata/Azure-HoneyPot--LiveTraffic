...
<p>Through Microsoft Azure I was able to quickly create and access machines that I can intentionally make susceptible to virtual attacks [i.e. a honeypot]. This VM was configured to run Windows 10, allow port 3389 access, and defaulted to all other minimal security settings available within this Azure account. </p>
